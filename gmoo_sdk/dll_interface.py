...
from gmoo_sdk.helpers import fortran_hollerith_string
...
class GMOOAPI:
    ...
    VSMEdevPokeCategoryLabel = DLLFunction("VSMEdevPokeCategoryLabel")
    ...
    def __init__(
        ...
        # Determine file path separator based on operating system
        ...
        self.visualization = VisualizationTools(self)
